from ..command_tree.arguments import ResourceLocationArgument, NBTArgument
...
func_node = literal("function").then(argument("path", ResourceLocationArgument()).executes(function_cmd).then(argument("nbt", NBTArgument()).executes(function_cmd)))
